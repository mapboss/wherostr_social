...
const uploadServices = ['https://nostr.build'];
...
class MediaService {
  ...
  // static Future<List<IMetaTag>> nip96(List<File> files) async {
  // }

  static Future<List<IMetaTag>> uploadMultiple(List<File> files) async {
    final request = http.MultipartRequest('POST', Uri.parse(uploadServices[0]));
